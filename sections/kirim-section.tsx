      ...
      <div className='grid grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-16'>
        ...
        <div className='relative mx-auto w-full max-w-lg'>
          ...
          <div className='relative h-[320px] w-[90%] overflow-hidden rounded-3xl shadow-lg md:h-[400px]'>
            ...
            <div className='absolute bottom-5 left-6 right-[52%]'>
          ...
          {/* Response badge */}
          <div className='animate-float-soft absolute right-1 top-6 flex items-center gap-3 rounded-2xl bg-background px-4 py-3 shadow-lg'>
